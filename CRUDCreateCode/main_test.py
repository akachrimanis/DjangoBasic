...
save_html_template(list_html, BASIC_APP_PATH, CURRENT_MODEL_NAME, f"""{CURRENT_MODEL_NAME}s-list.html""")
save_html_template(create_html, BASIC_APP_PATH, CURRENT_MODEL_NAME, f"{CURRENT_MODEL_NAME}-create.html")
save_html_template(update_html, BASIC_APP_PATH, CURRENT_MODEL_NAME, f"{CURRENT_MODEL_NAME}-update.html")
save_html_template(delete_html, BASIC_APP_PATH, CURRENT_MODEL_NAME, f"{CURRENT_MODEL_NAME}-delete.html")
